...
// Classe TarefaUrgente que herda de Tarefa e implementa Notificacao
class TarefaUrgente extends Tarefa implements Notificacao {
    ...
    // Sobrescreve exibirDetalhes para incluir notificação
    @Override
    public void exibirDetalhes() {
...
public class Main {
    public static void main(String[] args) {
        ...
        TarefaComAlerta tarefaComAlerta = new TarefaComAlerta("Preparar Apresentação", "Criar slides para a reunião", "2024-09-25", 2);
        ...
        System.out.println("--------------------------------------------");
        tarefaComAlerta.exibirDetalhes(); // Exibe os detalhes da tarefa com alerta
    }
}